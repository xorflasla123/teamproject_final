...
/* 메모 */
#first { display: none; position: fixed; z-index: 9; margin: 0 auto; top: 80px; left: 100; right: 0; height: 900px; width: 330px; background-color: white; }
	...
	<div id="first">
		<div style="width: 250px; margin: 0 auto; padding-top: 10px;">
			<form id="frm">
				...
				<b>제목</b>
				<input type="text" id="title" size="30" name="title"><br><br>
				...
				<div id="btns11">
					<input type="button" id="repBtn" onclick="saveMemo()" value="저장">
					<input type="button" id="cancelBtn" onclick="slide_hide()" value="취소">
					<input type="button" id="listBtn" onclick="memoList()" value="메모 목록">
				</div>
