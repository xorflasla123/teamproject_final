...
<form id="fo" action="register" method="post">
  ...
  <tr>
  <td>
  <input size="30" type="text" name="id" placeholder="아이디"><br>
  <input size="30" type="password" name="pw" placeholder="비밀번호"><br>
  <input size="30" type="password" name="chkPw" placeholder="비밀번호 확인"><br>
  <input size="30" type="text" name="name" placeholder="이름">
    <input size="30" type="text" name="email" placeholder="이메일">
    <input size="30" type="text" name="phoneNumber" placeholder="휴대전화">
  <input type="text" id="addr1" placeholder="주 소"><br>
  <input type="button" onclick="daumPost()" value="주소찾기"><br>
  <input type="text" id="addr2" placeholder="상 세 주 소"><br>
